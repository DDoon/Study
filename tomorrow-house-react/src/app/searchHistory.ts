...
export const { setSearchHistory, deleteSearchHistory, resetSearchHistory } = searchHistorySlice.actions

export default searchHistorySlice.reducer

export const getSearchHistory = (state: RootState) => state.searchHistory.histories